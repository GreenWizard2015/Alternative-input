"""Export TimeEncodingLayer weights and test data for JavaScript."""
...
def export_timeencodinglayer(args) -> Dict[str, Any]:
    """Export TimeEncodingLayer weights and test data.
    ...
    layer = TimeEncodingLayer()

    # Create test inputs to build the layer and create weights
    rng = np.random.RandomState(42)
    test_inputs = {
        "input": stabilize_input(rng.randn(2, 10, 1).astype(np.float32)),
    }
