"""Export ConvPE weights and test data for JavaScript."""
...
def export_convpe(args) -> Dict[str, Any]:
    """Export ConvPE weights and test data.
    ...
    test_inputs = {
        "input": stabilize_input(rng.randn(2, 32, 64, 3).astype(np.float32)),
    }
