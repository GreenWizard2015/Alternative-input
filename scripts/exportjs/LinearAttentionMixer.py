"""Export LinearAttentionMixer weights and test data for JavaScript."""
...
def export_linearattentionmixer(args) -> Dict[str, Any]:
    """Export LinearAttentionMixer weights and test data.
    ...
    layer = LinearAttentionMixer()  # Uses default max_dim=16
